...
const BusManagement = () => {
  ...
  const getValidationStyle = (fieldName, isEditing = false) => {
    ...
    return 'border-gray-300 focus:ring-gray-500';
  };
    ...
    try {
      ...
      autoTable(doc, {
        ...
        didDrawPage: function (data) {
          ...
          doc.text('Ahrthi travels Bus Fleet Management Report', pageWidth / 2, pageHeight - 5, { align: 'center' });
        }
      });
      ...
      // Save the PDF
      const fileName = `AhrthiTravels_BusReport_${currentDate.toISOString().split('T')[0]}_${Date.now()}.pdf`;
      doc.save(fileName);
              ...
              <div className="overflow-x-auto">
                <table className="w-full">
                  <thead className="bg-gradient-to-r from-gray-50 to-gray-100">
                    <tr>
                      <th className="px-6 py-3 text-left text-xs font-medium text-gray-800 uppercase tracking-wider">Image</th>
                      <th className="px-6 py-3 text-left text-xs font-medium text-gray-800 uppercase tracking-wider">Bus ID</th>
                      <th className="px-6 py-3 text-left text-xs font-medium text-gray-800 uppercase tracking-wider">Number Plate</th>
                      <th className="px-6 py-3 text-left text-xs font-medium text-gray-800 uppercase tracking-wider">Type</th>
                      <th className="px-6 py-3 text-left text-xs font-medium text-gray-800 uppercase tracking-wider">Brand</th>
                      <th className="px-6 py-3 text-left text-xs font-medium text-gray-800 uppercase tracking-wider">Model</th>
                      <th className="px-6 py-3 text-left text-xs font-medium text-gray-800 uppercase tracking-wider">Engine Number</th>
            ...
            <div className="grid grid-cols-1 gap-3">
              ...
              >
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-sm text-gray-700 font-medium">Add New Bus</span>
                </div>
              </button>
            ...
            <div className="relative bg-white border border-gray-200 rounded-xl p-6 z-60 w-full max-w-md shadow-2xl">
              ...
              <div className="grid grid-cols-2 gap-3 mb-4">
                <button
                  ...
                  className={`p-3 border-2 rounded-lg ${exportFormat === 'excel'
                ...
                <button
                  ...
                  className={`p-3 border-2 rounded-lg ${exportFormat === 'pdf'
            ...
            <div className="relative bg-white border border-gray-200 rounded-xl p-6 z-60 w-full max-w-4xl shadow-2xl">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                  <div>
                    ...
                    <select
                      ...
                      className={`p-3 bg-white border rounded-lg text-gray-800 placeholder-gray-400 focus:outline-none focus:ring-2 transition-colors w-full ${editingBus ? 'cursor-not-allowed opacity-50 border-gray-300' : 'border-gray-300 focus:ring-gray-500'
                        }`}
                      required
                      disabled={editingBus}
                    >
                  ...
                  <div>
                    ...
                    <select
                      ...
                      onChange={handleInputChange}
                      className="p-3 bg-white border border-gray-300 rounded-lg text-gray-800 focus:outline-none focus:ring-2 focus:ring-gray-500 transition-colors w-full"
                      required
                    >
                      <option value="Available">Available</option>
                      <option value="In Service">In Service</option>
                ...
                <div className="flex justify-end space-x-2">
                  ...
                  <button
                    type="submit"
                    className="flex items-center px-4 py-2 bg-gradient-to-r from-gray-800 to-black text-white rounded-lg hover:from-gray-700 hover:to-gray-900 shadow-md"
                  >
