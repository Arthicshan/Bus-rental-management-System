...
import gallery2 from "../assets/buspic2.png";
          ...
          <div className="max-w-7xl mx-auto px-6 lg:px-8 text-center">
            <div className="max-w-4xl mx-auto">
              ...
              <h1 className="text-6xl md:text-7xl lg:text-8xl font-bold mb-8 text-white leading-tight">
                Our <span className="bg-gradient-to-r from-gray-400 to-white bg-clip-text text-transparent">Gallery</span>
              </h1>
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
                <a
                  ...
                  className="bg-gradient-to-r from-gray-800 to-black hover:from-gray-700 hover:to-gray-900 text-white px-8 py-4 rounded-xl font-semibold transition-all duration-300 hover:scale-105 shadow-lg hover:shadow-xl flex items-center space-x-2"
                >
          ...
          <div className="flex flex-col lg:flex-row items-center justify-between gap-6">
            ...
            <div className="relative flex-1 max-w-md">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-gray-500 focus:border-gray-500 transition-all duration-300"
              />
            </div>
            ...
            <div className="flex flex-wrap gap-2">
              {categories.map((category) => (
                <button
                  ...
                  className={`px-4 py-2 rounded-xl font-medium transition-all duration-300 ${selectedCategory === category.id
            ...
            <div className="flex items-center space-x-2">
              <button
                ...
                className={`p-2 rounded-lg transition-all duration-300 ${viewMode === 'grid' ? 'bg-gray-800 text-white' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'
                  }`}
              >
              ...
              <button
                ...
                className={`p-2 rounded-lg transition-all duration-300 ${viewMode === 'list' ? 'bg-gray-800 text-white' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'
                  }`}
              >
            ...
            <div className="mt-6 text-white text-center">
              ...
              <div className="flex items-center justify-center space-x-4">
                <button
                  ...
                  className={`flex items-center space-x-2 px-4 py-2 rounded-lg transition-all duration-300 ${likedImages.has(selectedImage.id)
                ...
                <button
                  ...
                  className="flex items-center space-x-2 px-4 py-2 bg-white/20 text-white hover:bg-gray-500/50 rounded-lg transition-all duration-300"
                >
                  <Download className="w-4 h-4" />
                  <span>Download</span>
                </button>
