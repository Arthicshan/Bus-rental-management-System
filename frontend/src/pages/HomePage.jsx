...
import buspic2 from "../assets/buspic2.png";
...
const AdvancedBusRentalHomepage = () => {
  ...
  const defaultTestimonials = [
    {
      ...
      text: "Ahrthi travels exceeded all our expectations for our annual company retreat. The luxury coach was spotless, the driver was incredibly professional and punctual, and the onboard amenities made the 4-hour journey comfortable for all 45 employees. The booking process was seamless, and their customer service team was responsive throughout. We'll definitely be using them again for future events!",
      rating: 5,
    ...
    },
    {
      ...
      text: "We've been using Ahrthi travels for our executive transportation needs for over 2 years now. Their reliability is unmatched - never had a single delay or cancellation. The buses are always clean, well-maintained, and equipped with modern amenities. The drivers are courteous and professional. Their competitive pricing and excellent service make them our go-to choice for all corporate travel needs.",
      rating: 5,
    ...
    },
    {
      ...
      text: "Organized transportation for 200+ conference attendees using Ahrthi travels services. They provided multiple buses with perfect timing and coordination. The drivers were professional, the buses were clean and comfortable, and the service was exceptional. Many attendees specifically mentioned how impressed they were with the transportation. Will definitely use them for future events!",
      rating: 5,
        ...
        if (response.ok) {
          ...
          if (testimonials.length > 0) {
            ...
            const transformedTestimonials = testimonials.map(feedback => ({
              ...
              company: "Ahrthi travels Customer",
  ...
  const Footer = () => {
    return (
      <footer className="w-full px-6 lg:px-8 py-12 bg-gradient-to-br from-gray-100 to-gray-200">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-5 gap-8">
          <div className="space-y-5 col-span-2">
            <div className="flex items-center space-x-3">
              <div className="relative">
                <div className="bg-gradient-to-r from-gray-800 to-black p-3 rounded-xl shadow-lg">
        ...
        <div className="max-w-7xl mx-auto mt-8 pt-6 border-t border-blue-200 text-center">
          <p className="text-slate-500 text-sm">
            © {new Date().getFullYear()} Ahrthi travels. All rights reserved.
          </p>
        </div>
      </footer>
    );
      ...
      >
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-3">
              <div className="relative">
                <div className={`p-3 rounded-xl shadow-lg transition-all duration-500 ${isScrolled
                  ? "bg-gradient-to-r from-gray-800 to-black"
                  : "bg-white/20 backdrop-blur-sm"
                  }`}>
                  <Bus className={`h-8 w-8 transition-colors duration-500 ${isScrolled ? "text-white" : "text-white"
                    }`} />
                </div>
                <div className={`absolute -top-1 -right-1 w-4 h-4 rounded-full transition-all duration-500 ${isScrolled ? "bg-cyan-500" : "bg-white/60"
                  }`}></div>
              </div>
              <div>
                <div className={`text-2xl font-bold transition-all duration-500 ${isScrolled
                  ? "bg-gradient-to-r from-gray-800 to-black bg-clip-text text-transparent"
                  : "text-white"
                  }`}>
                  Ahrthi travels
                </div>
                <div className={`text-xs transition-colors duration-500 ${isScrolled ? "text-blue-600/70" : "text-white/80"
                  }`}>
                  Premium Bus Rentals
                </div>
              </div>
            ...
            <div className="hidden lg:flex items-center space-x-8">
              {[
                ...
                <a
                  ...
                  className={`relative px-4 py-2 text-sm font-medium transition-all duration-500 group ${item.active
                ...
                >
                  {item.name}
                  <span
                    className={`absolute -bottom-1 left-0 w-0 h-0.5 transition-all duration-500 group-hover:w-full ${item.active ? "w-full" : ""
                      } ${isScrolled
                        ? "bg-gradient-to-r from-gray-800 to-black"
                        : "bg-white"
                      }`}
            ...
            <div className="hidden lg:flex items-center space-x-6">
              <div className={`flex items-center space-x-2 group transition-colors duration-500 ${isScrolled ? "text-slate-700" : "text-white/90"
                }`}>
                <div className="relative">
                  <Phone className={`h-4 w-4 group-hover:animate-bounce transition-colors duration-500 ${isScrolled ? "text-blue-600" : "text-white"
                    }`} />
                  <div className={`absolute -top-1 -right-1 w-2 h-2 rounded-full animate-ping transition-colors duration-500 ${isScrolled ? "bg-blue-600" : "bg-white/60"
                    }`}></div>
                </div>
                <span className={`text-sm transition-colors duration-500 ${isScrolled
              ...
              <div className="flex items-center space-x-3">
                <button
                  className={`px-6 py-2.5 rounded-xl font-semibold transition-all duration-500 hover:scale-105 shadow-lg ${isScrolled
            ...
            <button
              ...
              className={`lg:hidden p-2 rounded-lg transition-all duration-500 ${isScrolled
        ...
        <div className="absolute bottom-8 left-1/2 -translate-x-1/2 z-20 flex space-x-3">
          {heroSlides.map((_, index) => (
            <button
              ...
              className={`w-12 h-2 rounded-full transition-all duration-300 relative overflow-hidden group ${index === currentSlide ? "bg-blue-500" : "bg-white/50"
                }`}
            >
              {index === currentSlide && (
