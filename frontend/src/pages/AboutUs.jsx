...
const AboutUs = () => {
  ...
  const testimonials = [
    {
      name: "Sarah Johnson",
      role: "CEO, TechCorp",
      text: "Ahrthi travels has been our trusted transportation partner for over 5 years. Their reliability and professionalism are unmatched.",
      rating: 5,
    ...
    },
    {
      ...
      text: "Ahrthi travels made our destination wedding transportation absolutely flawless. Our guests were genuinely impressed.",
      rating: 5,
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-100 text-slate-800">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-6">
              <button
                onClick={() => navigate('/')}
                className={`flex items-center space-x-2 transition-all duration-500 px-4 py-2 rounded-lg ${isScrolled
          ...
          <div className="max-w-7xl mx-auto px-6 lg:px-8 text-center">
            <div className="max-w-4xl mx-auto">
              ...
              <h1 className="text-6xl md:text-7xl lg:text-8xl font-bold mb-8 text-white leading-tight">
                About <span className="bg-gradient-to-r from-gray-400 to-white bg-clip-text text-transparent">Ahrthi travels</span>
              </h1>
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
                <button className="bg-gradient-to-r from-gray-800 to-black hover:from-gray-700 hover:to-gray-900 text-white px-8 py-4 rounded-xl font-semibold transition-all duration-300 hover:scale-105 shadow-lg hover:shadow-xl flex items-center space-x-2">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <div className="space-y-6 text-slate-600 text-lg leading-relaxed">
                <p>
                  Ahrthi travels is a well-established transportation service provider specializing in
                  bus rentals for events, city transfers, and long-distance tours. The company operates from its head office
                  in Trincomalee and has built a strong reputation for reliability and timely service.
                </p>
                <p>
            ...
            <div className="relative">
              <div className="bg-gradient-to-br from-gray-800 to-black p-8 rounded-2xl text-white shadow-2xl">
              ...
              return (
                <div key={index} className="group bg-white p-8 rounded-2xl border border-gray-200 hover:border-blue-300 transition-all duration-300 hover:-translate-y-2 shadow-lg hover:shadow-xl">
                  <div className="flex items-start space-x-6">
                    <div className="bg-gradient-to-r from-gray-800 to-black p-4 rounded-2xl group-hover:scale-110 transition-transform duration-300 shadow-lg">
                      <Icon className="h-8 w-8 text-white" />
                    </div>
              ...
              {achievements.map((achievement, index) => {
                ...
                return (
                  <div key={index} className={`flex items-center ${isEven ? 'flex-row' : 'flex-row-reverse'}`}>
                    <div className={`w-1/2 ${isEven ? 'pr-8 text-right' : 'pl-8 text-left'}`}>
                      <div className="bg-white p-8 rounded-2xl border border-gray-200 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-2">
                        <div className="flex items-center space-x-4 mb-4">
                          <div className="bg-gradient-to-r from-gray-800 to-black p-3 rounded-xl">
                            <Icon className="h-6 w-6 text-white" />
                          </div>
                          <div>
                            <div className="text-2xl font-bold text-gray-800">{achievement.year}</div>
                    ...
                    <div className="w-16 h-16 bg-white border-4 border-gray-800 rounded-full flex items-center justify-center z-10 shadow-lg">
      ...
      <div className="py-20 bg-gradient-to-br from-gray-800 via-gray-900 to-black relative overflow-hidden">
        <div className="absolute inset-0">
        ...
        <div className="max-w-6xl mx-auto px-6 lg:px-8 text-center relative z-10">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-6 mb-12">
              <button className="bg-white hover:bg-gray-50 text-gray-800 px-8 py-4 rounded-2xl font-bold text-lg transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl flex items-center space-x-3 group">
                <Phone className="h-6 w-6 group-hover:animate-bounce" />
                <span>Call 0727272750</span>
              </button>
