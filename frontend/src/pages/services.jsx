...
const Services = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-100 text-slate-800">
        ...
        <div className="relative h-96 w-full">
          ...
          <div className="absolute inset-0 z-20 flex flex-col items-center justify-center text-center px-4">
            <h1 className="text-5xl md:text-6xl font-bold mb-6 text-white">
              Our <span className="bg-gradient-to-r from-gray-400 to-white bg-clip-text text-transparent">Services</span>
            </h1>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-white/80 backdrop-blur-sm p-6 rounded-3xl border border-blue-200/50 hover:border-blue-400/50 transition-all duration-300 shadow-lg hover:shadow-xl">
              ...
              <button className="w-full bg-gradient-to-r from-gray-800 to-black hover:from-gray-700 hover:to-gray-900 text-white font-semibold py-3 px-4 rounded-xl transition-all duration-300">
                View Details
              </button>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="bg-white/80 backdrop-blur-sm p-8 rounded-3xl border border-blue-200/50 shadow-lg">
              <div className="flex items-center mb-6">
                <div className="bg-gradient-to-r from-gray-800 to-black p-3 rounded-xl mr-4 shadow-lg">
      ...
      {/* CTA Section */}
      <div className="bg-gradient-to-r from-gray-800 to-black py-16 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8 text-center relative z-10">
          ...
          <button
            ...
            className="bg-white hover:bg-gray-100 text-gray-800 px-8 py-4 rounded-2xl font-bold text-lg transition-all duration-300 transform hover:scale-105 shadow-lg"
          >
            Contact Us
          </button>
        </div>
