...
const ContactUs = () => {
  ...
  const contactMethods = [
    ...
    },
    {
      ...
      contact: "ahrthitravels@gmail.com",
    ...
    },
    {
      ...
      contact: "18, Orrshill, Trincomalee",
            ...
            <div>
              ...
              <div className="space-y-8">
                <div className="flex items-start space-x-4">
                  <div className="bg-gradient-to-r from-gray-800 to-black p-4 rounded-2xl shadow-lg">
                    <Phone className="h-6 w-6 text-white" />
                  </div>
                  <div>
                    <h3 className="text-xl font-bold mb-2 text-slate-800">Phone</h3>
                    <p className="text-slate-600 text-lg">0727272750</p>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-slate-600 text-lg">ahrthitravels@gmail.com</p>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-slate-600 text-lg">18, Orrshill, Trincomalee</p>
                    <p className="text-slate-600">Trincomalee, Sri Lanka</p>
                  </div>
                </div>
              </div>
            ...
            <div>
              <div className="bg-white p-8 rounded-2xl border border-gray-200 shadow-xl">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <button
                    type="submit"
                    className="w-full bg-gradient-to-r from-gray-800 to-black hover:from-gray-700 hover:to-gray-900 text-white font-bold py-4 px-6 rounded-xl transition-all duration-300 transform hover:scale-105 flex items-center justify-center space-x-3 shadow-lg hover:shadow-xl"
                  >
            ...
            <div className="bg-gradient-to-r from-gray-800 to-black p-8 text-white">
              <div className="flex items-center justify-center space-x-4">
                ...
                <div className="text-center">
                  ...
                  <div className="text-blue-100">18, Orrshill, Trincomalee</div>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-6xl mx-auto px-6 lg:px-8 text-center relative z-10">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-6 mb-12">
              <a href="tel:0727272750" className="bg-white hover:bg-gray-50 text-gray-800 px-8 py-4 rounded-2xl font-bold text-lg transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl flex items-center space-x-3 group">
                <Phone className="h-6 w-6 group-hover:animate-bounce" />
                <span>Call 0727272750</span>
              </a>

              <a href="mailto:ahrthitravels@gmail.com" className="bg-white/10 backdrop-blur-sm text-white border border-white/30 hover:bg-white/20 px-8 py-4 rounded-2xl font-bold text-lg transition-all duration-300 transform hover:scale-105 flex items-center space-x-3 group">
