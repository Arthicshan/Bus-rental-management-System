...
const StatusBadge = ({ status }) => {
  ...
  const colors = {
    ...
    driver: "bg-gray-100 text-gray-800 border border-gray-200",
...
const UserAvatar = ({ src, name, className = "" }) => {
  if (!src) {
    return (
      <div
        className={`bg-gradient-to-br from-gray-500 to-gray-600 rounded-full flex items-center justify-center text-white font-medium shadow-md ${className}`}
      >
...
const Modal = ({ title, onClose, children }) => (
  <div className="fixed inset-0 z-50 flex items-start justify-center overflow-auto pt-12">
    ...
    <div className="relative bg-white border border-gray-200 rounded-xl p-6 z-60 w-full max-w-4xl shadow-2xl">
                    ...
                    <tr className="bg-gray-50">
                      ...
                      >
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
                          ...
                          <div>
                            <span className="font-medium text-gray-800">NIC:</span>{" "}
                            {row.nic || "—"}
                          </div>
                          <div>
...
const FormField = ({
  ...
  <div>
    ...
    <input
      ...
      value={value}
      onChange={onChange}
      className={`p-3 bg-white border rounded-lg text-gray-800 placeholder-gray-400 focus:outline-none focus:ring-2 transition-colors w-full ${validation[field]?.checked
        ? (() => {
...
const UserManagement = () => {
  ...
  const createUser = async (role) => {
    ...
    try {
      ...
      toast.success(
        `${role.charAt(0).toUpperCase() + role.slice(1)} created successfully! ${role === "driver" ? "Login credentials have been sent to the driver's email." :
  ...
  const exportPDF = (list) => {
    ...
    autoTable(doc, {
      ...
      didDrawPage: function (data) {
        ...
        doc.text('Ahrthi travels User Management Report', pageWidth / 2, pageHeight - 5, { align: 'center' });
      }
    });
    ...
    // Save the PDF
    const fileName = `AhrthiTravels_UserReport_${currentDate.toISOString().split('T')[0]}_${Date.now()}.pdf`;
    doc.save(fileName);
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 p-6">
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="col-span-2 bg-white rounded-xl p-6 border border-gray-200 shadow-lg">
            <div className="flex items-center space-x-3 mb-4">
              <div className="relative flex-1">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="pl-10 pr-4 py-2 bg-white border border-gray-300 text-gray-800 rounded-lg w-full focus:ring-2 focus:ring-gray-500 focus:border-gray-500"
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <select
                  ...
                  className="bg-white text-gray-800 px-3 py-2 rounded-lg border border-gray-300 focus:ring-2 focus:ring-gray-500 focus:border-gray-500"
                >
          ...
          <div className="bg-white rounded-xl p-6 border border-gray-200 shadow-lg">
            ...
            <div className="grid grid-cols-1 gap-3">
              <button
                ...
                className="flex items-center justify-between px-4 py-3 bg-gray-50 border border-gray-200 rounded-lg hover:bg-gray-100 transition-colors group"
              >
                <div className="flex items-center space-x-3">
                  <Plus className="w-5 h-5 text-gray-600 group-hover:text-gray-700" />
                  <span className="text-sm text-gray-700 font-medium">Add Driver</span>
                </div>
              </button>
              ...
              >
                <div className="flex items-center space-x-3">
                  <Plus className="w-5 h-5 text-gray-600 group-hover:text-gray-700" />
                  <span className="text-sm text-gray-700 font-medium">Add Staff</span>
                </div>
              </button>
              ...
              >
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-sm text-gray-700 font-medium">Export All</span>
                </div>
              </button>
            </div>
          </div>
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
              ...
              <div>
                ...
                <input
                  ...
                  className={`p-3 bg-white border rounded-lg text-gray-800 placeholder-gray-400 focus:outline-none focus:ring-2 transition-colors w-full ${validation.nic?.checked
                    ? (() => {
                      // For fields with both isValid and available (phone, nic)
            ...
            <div className="flex justify-end space-x-2">
              ...
              <button
                ...
                className={`px-4 py-2 rounded-lg text-white font-medium transition-colors flex items-center justify-center ${isFormValid("driver") && !creating
                  ? "bg-gradient-to-r from-gray-800 to-black hover:from-gray-700 hover:to-gray-900 shadow-md"
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
              ...
              <div>
                ...
                <input
                  ...
                  className="p-3 bg-white border border-gray-300 rounded-lg text-gray-800 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-gray-500 transition-colors w-full"
                />
                {!form.staffRole && (
                  <p className="text-gray-500 text-xs mt-1">
            ...
            <div className="flex justify-end space-x-2">
              ...
              <button
                ...
                className={`px-4 py-2 rounded-lg text-white font-medium transition-colors flex items-center justify-center ${isFormValid("staff") && !creating
                  ? "bg-gradient-to-r from-gray-800 to-black hover:from-gray-700 hover:to-gray-900 shadow-md"
                  : "bg-gray-400 cursor-not-allowed"
                  }`}
