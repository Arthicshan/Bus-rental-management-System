...
const RegisterPage = () => {
  ...
  const getBorderColor = (fieldName, isValid, isAvailable, isChecking) => {
    ...
    if (isChecking) {
      return 'border-gray-500'; // Blue border while checking
    }
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-100 relative overflow-hidden flex items-center justify-center p-4">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute top-10 left-10 w-72 h-72 bg-gray-400/20 rounded-full blur-3xl animate-pulse"></div>
        <div className="absolute bottom-20 right-20 w-96 h-96 bg-gray-400/20 rounded-full blur-3xl animate-pulse delay-1000"></div>
        <div className="absolute top-1/2 left-1/3 w-64 h-64 bg-gray-400/20 rounded-full blur-2xl animate-bounce"></div>
      </div>

      {/* Home Button */}
      <button
        onClick={handleHomeClick}
        className="absolute top-8 left-8 z-20 flex items-center gap-3 px-6 py-3 bg-white/80 backdrop-blur-lg hover:bg-white text-slate-700 rounded-2xl shadow-xl transition-all duration-300 hover:scale-105 border border-gray-200/50"
      >
        ...
        <div className="w-full flex items-center justify-center">
          <div className="w-full max-w-lg">
            ...
            <div className="lg:hidden text-center mb-8">
              <div className="w-20 h-20 mx-auto mb-4 bg-gradient-to-br from-gray-800 to-black rounded-2xl flex items-center justify-center shadow-lg">
                <FaBus className="text-3xl text-white" />
              </div>
              <h1 className="text-3xl font-bold text-slate-800">Ahrthi travels</h1>
              <p className="text-slate-600 mt-2">Create your account to get started</p>
            </div>

            {/* Registration Card */}
            <div className="bg-white/95 backdrop-blur-xl rounded-3xl shadow-2xl p-10 border border-gray-200/50">
              <div className="text-center mb-8">
                <div className="w-16 h-16 mx-auto mb-4 bg-gradient-to-br from-gray-800 to-black rounded-2xl flex items-center justify-center shadow-lg">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <label htmlFor="firstName" className="block text-sm font-semibold text-slate-700 mb-3">
                      <FaUser className="inline mr-2 text-gray-500 text-xs" />
                      First Name
                    </label>
                    <input
                      id="firstName"
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <div className="relative">
                      <input
                        ...
                        type="text"
                        required
                        className={`w-full px-4 py-3 border-2 rounded-xl focus:ring-2 focus:ring-gray-500 focus:border-transparent transition-all duration-200 bg-gray-50 focus:bg-white text-gray-800 placeholder-gray-500 text-sm ${getBorderColor('username', null, usernameAvailable, checkingUsername)
                          }`}
                  ...
                  <div>
                    <label htmlFor="email" className="block text-sm font-semibold text-slate-700 mb-3">
                      <FaEnvelope className="inline mr-2 text-gray-500 text-xs" />
                      Email Address
                    </label>
                    <div className="relative">
                      <input
                        ...
                        type="email"
                        required
                        className={`w-full px-4 py-3 border-2 rounded-xl focus:ring-2 focus:ring-gray-500 focus:border-transparent transition-all duration-200 bg-gray-50 focus:bg-white text-gray-800 placeholder-gray-500 text-sm ${getBorderColor('email', emailValid, emailAvailable, checkingEmail)
                          }`}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <label htmlFor="phone" className="block text-sm font-semibold text-slate-700 mb-3">
                      <FaPhone className="inline mr-2 text-gray-500 text-xs" />
                      Phone Number
                    </label>
                    <div className="relative">
                      <input
                        ...
                        name="phone"
                        type="text"
                        className={`w-full px-4 py-3 border-2 rounded-xl focus:ring-2 focus:ring-gray-500 focus:border-transparent transition-all duration-200 bg-gray-50 focus:bg-white text-gray-800 placeholder-gray-500 text-sm ${getBorderColor('phone', phoneValid, phoneAvailable, checkingPhone)
                          }`}
                  ...
                  <div>
                    <label htmlFor="nic" className="block text-sm font-semibold text-slate-700 mb-3">
                      <FaIdCard className="inline mr-2 text-gray-500 text-xs" />
                      NIC Number
                    </label>
                    <div className="relative">
                      <input
                        ...
                        type="text"
                        required
                        className={`w-full px-4 py-3 border-2 rounded-xl focus:ring-2 focus:ring-gray-500 focus:border-transparent transition-all duration-200 bg-gray-50 focus:bg-white text-gray-800 placeholder-gray-500 text-sm ${getBorderColor('nic', nicValid, nicAvailable, checkingNIC)
                          }`}
                ...
                <div>
                  <label htmlFor="address" className="block text-sm font-semibold text-slate-700 mb-3">
                    <FaMapMarkerAlt className="inline mr-2 text-gray-500 text-xs" />
                    Address
                  </label>
                  <input
                    id="address"
                    name="address"
                    type="text"
                    className="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:ring-2 focus:ring-gray-500 focus:border-transparent transition-all duration-200 bg-gray-50 focus:bg-white text-gray-800 placeholder-gray-500 text-sm"
                ...
                <div>
                  <label htmlFor="password" className="block text-sm font-semibold text-slate-700 mb-3">
                    <FaLock className="inline mr-2 text-gray-500 text-xs" />
                    Password
                  </label>
                  <div className="relative">
                    <input
                      ...
                      required
                      className={`w-full px-4 py-3 border-2 rounded-xl focus:ring-2 focus:ring-gray-500 focus:border-transparent transition-all duration-200 bg-gray-50 focus:bg-white text-gray-800 placeholder-gray-500 text-sm ${!hasInteracted.password ? 'border-gray-200' :
                    ...
                    <div className="mt-3">
                      ...
                      <div className="mt-2 text-xs text-gray-600 grid grid-cols-2 gap-1">
                        ...
                        <p className={/[!@#$%^&*()_+\-=\[\]{};':"\\|,.<>\/?`~]/.test(formData.password) ? 'text-green-600' : 'text-red-600'}>
                          • Special char {/[!@#$%^&*()_+\-=\[\]{};':"\\|,.<>\/?`~]/.test(formData.password) ? '✓' : '✗'}
                        </p>
                      </div>
                    </div>
                  )}
                ...
                <button
                  ...
                  className="w-full py-4 px-6 bg-gradient-to-r from-gray-800 to-black hover:from-gray-700 hover:to-gray-900 text-white font-bold rounded-2xl shadow-lg hover:shadow-xl transform transition-all duration-300 hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none text-lg"
                >
                  {loading ? (
              ...
              <div className="text-center mt-8 pt-6 border-t border-gray-200">
                <p className="text-slate-600">
                  ...
                  <Link
                    to="/login"
                    className="font-bold text-gray-800 hover:text-black transition-colors duration-200"
                  >
                    Sign In
                  </Link>
                </p>
