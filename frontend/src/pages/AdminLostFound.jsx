...
const AdminLostFound = () => {
  ...
  const fetchLostItems = async () => {
    try {
      ...
      const savedItems = localStorage.getItem('ahrthitravels_lost_items');
      if (savedItems) {
        try {
      ...
      if (response.ok) {
        ...
        try {
          localStorage.setItem('ahrthitravels_lost_items', JSON.stringify(apiItems));
        ...
        try {
          localStorage.setItem('ahrthitravels_lost_items', JSON.stringify(mockData));
  ...
  const exportPDF = (items) => {
    ...
    const cardColors = [
      [30, 30, 30],   // Total Item - Dark gray
      [50, 50, 50],    // Reported - Slightly lighter gray  
      [80, 80, 80],   // Found - Lighter gray
      [10, 10, 10]     // Not Found - Black
    ];
    ...
    autoTable(doc, {
      ...
      didDrawPage: function (data) {
        ...
        doc.text('Ahrthi travels Lost & Found Report', pageWidth / 2, pageHeight - 5, { align: 'center' });
      }
    });
    ...
    if (finalY < pageHeight - 40) {
      ...
      doc.text('For support, contact: ahrthitravels@gmail.com | 0727272750', pageWidth / 2, finalY + 25, { align: 'center' });
    }

    // Save the PDF
    const fileName = `AhrthiTravels_LostFoundReport_${currentDate.toISOString().split('T')[0]}_${Date.now()}.pdf`;
    doc.save(fileName);
  ...
  const handleAdminReply = async (e) => {
    ...
    try {
      ...
      setLostItems(prev => {
        ...
        try {
          localStorage.setItem('ahrthitravels_lost_items', JSON.stringify(updatedItems));
          ...
          <div className="space-y-4">
            ...
            <div className="flex space-x-2">
              <button
                ...
                className="flex-1 flex items-center justify-center px-4 py-2 bg-gradient-to-r from-gray-800 to-black hover:from-gray-700 hover:to-gray-900 text-white rounded-lg font-medium transition-colors shadow-md"
              >
          ...
          {loading ? (
            ...
            <div className="text-center py-20">
              ...
              <button
                ...
                className="px-6 py-2 bg-gradient-to-r from-gray-800 to-black hover:from-gray-700 hover:to-gray-900 text-white rounded-lg font-medium transition-colors shadow-md"
              >
                ...
                <div key={item._id} className="p-6 hover:bg-gray-50 transition-colors">
                      ...
                      {item.user && (
                        <div className="mt-3 p-3 bg-gray-50 border border-gray-200 rounded-lg">
                          <div className="flex items-center justify-between mb-2">
                            <h4 className="text-sm font-medium text-gray-800">User Contact Information</h4>
                  ...
                  <div className="flex items-center justify-end space-x-2 pt-4 border-t border-gray-200">
                    <button
                      ...
                      className="px-3 py-1 text-gray-500 hover:text-gray-600 transition-colors flex items-center text-sm hover:bg-gray-50 rounded"
                    >
                    ...
                    <button
                      ...
                      className="px-3 py-1 text-gray-600 hover:text-gray-700 transition-colors flex items-center text-sm hover:bg-gray-50 rounded"
                    >
            ...
            <form onSubmit={handleAdminReply} className="space-y-4">
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full px-4 py-3 bg-white border border-gray-200 rounded-lg text-slate-800 focus:outline-none focus:ring-2 focus:ring-gray-500 shadow-sm"
                  required
                >
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={6}
                  className="w-full px-4 py-3 bg-white border border-gray-200 rounded-lg text-slate-800 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-gray-500 resize-none shadow-sm"
                  placeholder={
              ...
              <div className="flex space-x-3 pt-4">
                ...
                <button
                  type="submit"
                  disabled={submitting}
                  className={`flex-1 px-4 py-3 text-white rounded-lg font-medium transition-all duration-300 disabled:cursor-not-allowed shadow-lg ${selectedStatus === 'Found' ? 'bg-gradient-to-r from-green-500 to-emerald-600 hover:from-green-400 hover:to-emerald-500' :
                    selectedStatus === 'Returned' ? 'bg-gradient-to-r from-purple-500 to-violet-600 hover:from-purple-400 hover:to-violet-500' :
                      selectedStatus === 'Claimed' ? 'bg-gradient-to-r from-gray-800 to-black hover:from-gray-700 hover:to-gray-900' :
                      ...
                      <div className="space-y-2 text-sm">
                        ...
                        {viewingItem.deliveryStatus && (
                          <div className="flex justify-between">
                            ...
                            <span className={`px-2 py-1 rounded-full text-xs font-medium ${viewingItem.deliveryStatus === 'Delivered' ? 'bg-green-100 text-green-800' :
          ...
          <div className="relative bg-white border border-gray-200 rounded-xl p-6 z-60 w-full max-w-md shadow-2xl">
            ...
            <div className="flex justify-end space-x-2 mt-6">
              ...
              <button
                ...
                disabled={submitting}
                className="px-4 py-2 bg-gradient-to-r from-gray-800 to-black hover:from-gray-700 hover:to-gray-900 text-white rounded-lg transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed shadow-md"
              >
