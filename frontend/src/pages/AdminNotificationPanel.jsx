...
const AdminNotificationPanel = () => {
  ...
  const ExportModal = ({ show, onClose, format, setFormat, itemCount, onExport, loading }) => {
    ...
    return (
      <div className="fixed inset-0 z-50 flex items-center justify-center">
        ...
        <div className="relative bg-white border border-gray-200 rounded-xl p-6 z-60 w-full max-w-md shadow-2xl">
          ...
          <div className="grid grid-cols-2 gap-3 mb-4">
            <button
              ...
              className={`p-3 border-2 rounded-lg ${format === "csv"
            ...
            <button
              ...
              className={`p-3 border-2 rounded-lg ${format === "pdf"
          ...
          <div className="bg-gray-50 rounded p-2 text-sm text-gray-700 mb-4">
          ...
          <div className="flex justify-end space-x-2">
            ...
            <button
              onClick={onExport}
              disabled={loading}
              className="px-4 py-2 bg-gradient-to-r from-gray-800 to-black text-white rounded-lg hover:from-gray-700 hover:to-gray-900 shadow-md"
            >
  ...
  const exportPDF = (list) => {
    ...
    doc.text('Ahrthi travels', margin, margin + 10);
    ...
    autoTable(doc, {
      ...
      didDrawPage: function (data) {
        ...
        doc.text('Ahrthi travels Notification Management Report', pageWidth / 2, pageHeight - 5, { align: 'center' });
      }
    });
    ...
    if (finalY < pageHeight - 40) {
      ...
      doc.setTextColor(100, 100, 100);
      doc.setFont(undefined, 'normal');
      doc.text('This report was generated by Ahrthi travels Management System', pageWidth / 2, finalY + 20, { align: 'center' });
      doc.text('For support, contact: info@ahrthitravels.com | +94 704 222 777', pageWidth / 2, finalY + 25, { align: 'center' });
    }

    // Save the PDF
    const fileName = `AhrthiTravels_NotificationReport_${currentDate.toISOString().split('T')[0]}_${Date.now()}.pdf`;
    doc.save(fileName);
  ...
  const notificationTypes = [
    ...
    { value: 'update', label: 'Update', color: 'bg-gray-700' },
  ...
  const statusTypes = [
    ...
    { value: 'scheduled', label: 'Scheduled', color: 'bg-gray-700' },
  ...
  const getStatusIcon = (status) => {
    switch (status) {
      ...
      case 'scheduled':
        return <div className="w-3 h-3 rounded-full bg-gray-700"></div>;
      case 'sent':
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 p-6">
      <div className="flex justify-between items-center mb-6">
        <h2 className="text-2xl font-bold text-gray-800 flex items-center">
          ...
          <span className="ml-3 bg-gray-500 text-white text-sm font-medium px-2 py-1 rounded-full">
        ...
        <div className="flex space-x-3">
          <button
            ...
            className="flex items-center space-x-2 bg-white hover:bg-gray-50 text-gray-700 border border-gray-300 px-4 py-2 rounded-lg transition-colors"
          >
          ...
          <button
            onClick={refreshData}
            disabled={refreshing}
            className="flex items-center space-x-2 bg-white hover:bg-gray-50 text-gray-700 border border-gray-300 px-4 py-2 rounded-lg transition-colors disabled:opacity-50"
          >
          ...
          <div className="flex justify-end">
            <div className="relative w-full max-w-md">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2 bg-white border border-gray-300 rounded-lg text-gray-800 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:border-gray-500"
              />
            </div>
          </div>
          ...
          {showFilters && (
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <select
                ...
                className="px-3 py-2 bg-white border border-gray-300 rounded-lg text-gray-800 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:border-gray-500"
              >
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  className={`w-full px-3 py-2 bg-white border ${formErrors.title ? 'border-red-500' : 'border-gray-300'} rounded-lg text-gray-800 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:border-gray-500`}
              ...
              <div>
                ...
                <select
                  ...
                  className={`w-full px-3 py-2 bg-white border ${formErrors.type ? 'border-red-500' : 'border-gray-300'} rounded-lg text-gray-800 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:border-gray-500`}
                >
                  {notificationTypes.map(type => (
                    <option key={type.value} value={type.value}>{type.label}</option>
                  ))}
            ...
            <div>
              ...
              <textarea
                ...
                rows={3}
                className={`w-full px-3 py-2 bg-white border ${formErrors.message ? 'border-red-500' : 'border-gray-300'} rounded-lg text-gray-800 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:border-gray-500`}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <select
                  ...
                  className={`w-full px-3 py-2 bg-white border ${formErrors.targetAudience ? 'border-red-500' : 'border-gray-300'} rounded-lg text-gray-800 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:border-gray-500`}
                >
              ...
              <div>
                ...
                <select
                  ...
                  className={`w-full px-3 py-2 bg-white border ${formErrors.deliveryChannel ? 'border-red-500' : 'border-gray-300'} rounded-lg text-gray-800 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:border-gray-500`}
                >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  className={`w-full px-3 py-2 bg-white border ${dateErrors.expiresAt ? 'border-red-500' : 'border-gray-300'} rounded-lg text-gray-800 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:border-gray-500`}
                />
              ...
              <div>
                ...
                <input
                  ...
                  min={new Date().toISOString().slice(0, 16)}
                  className={`w-full px-3 py-2 bg-white border ${dateErrors.sendAt ? 'border-red-500' : 'border-gray-300'} rounded-lg text-gray-800 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:border-gray-500`}
                />
                {dateErrors.sendAt ? (
            ...
            <div>
              ...
              <select
                ...
                className="w-full px-3 py-2 bg-white border border-gray-300 rounded-lg text-gray-800 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:border-gray-500"
              >
        ...
        <div className="p-4 bg-gradient-to-r from-gray-50 to-gray-100 flex justify-between items-center">
          ...
          <div className="text-sm text-gray-600">
            ...
            {(searchTerm || statusFilter !== 'all' || typeFilter !== 'all') && (
              <span className="ml-2 text-gray-600">(Filtered)</span>
            )}
          </div>
        </div>
          ...
          <table className="w-full">
            <thead className="bg-gradient-to-r from-gray-50 to-gray-100">
              <tr>
                ...
                <th className="px-6 py-3 text-left text-xs font-medium text-gray-800 uppercase tracking-wider">CHANNEL</th>
                <th className="px-6 py-3 text-left text-xs font-medium text-gray-800 uppercase tracking-wider">STATUS</th>
                <th className="px-6 py-3 text-left text-xs font-medium text-gray-800 uppercase tracking-wider">EXPRESS</th>
            ...
            <tbody className="divide-y divide-gray-100">
              {filteredNotifications.length === 0 ? (
                ...
                filteredNotifications.map(notification => {
                  ...
                  return (
                    <tr key={notification._id} className="hover:bg-gray-50 transition-colors duration-200">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div className="flex items-center space-x-2">
                          ...
                          <select
                            ...
                            className="text-xs bg-white border border-gray-300 rounded px-2 py-1 text-gray-800 focus:outline-none focus:ring-1 focus:ring-gray-500"
                          >
                            <option value="draft">Draft</option>
                            <option value="sent">Sent</option>
                            <option value="scheduled">Scheduled</option>
